...
export default function UploadPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("marksForCorrect", marksForCorrect);
      formData.append("negativeMarks", negativeMarks);
      formData.append("timerMinutes", timerMinutes);
        ...
        <section className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-3xl bg-white p-8 shadow-lg">
            ...
            <ul className="mt-4 space-y-3 text-slate-600">
              ...
              <li>
                2. The backend parses text and extracts structured questions.
              </li>
          ...
          <div className="rounded-3xl bg-white p-8 shadow-lg">
            ...
            <p className="mt-4 text-slate-600">
              The system supports basic PDF text extraction and will fall back
              to sample questions if extraction fails.
            </p>
          </div>
        </section>
      </main>
